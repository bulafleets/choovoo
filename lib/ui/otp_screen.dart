...
class CustomOtpScreen extends StatefulWidget {
 ...
 final String password;
  ...
  CustomOtpScreen({ Key key,  this.emailid, this.phoneno, this.password}) : super(key: key);
  @override
...
class _CustomOtpScreenState extends State<CustomOtpScreen> {
        ...
        onPressed: () {
           if(_formkey.currentState.validate()) {
             ...
             Navigator.push(
                 ...
                 MaterialPageRoute(
                     builder: (context) =>
                         ProfileScreen(emailid: widget.emailid,
  ...
  Future<void> sendOTP() async {
    ...
    final response = await http.post( Uri.parse(URL_OTP),
      body: {
